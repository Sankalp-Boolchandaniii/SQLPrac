...
select * from apartments a join characters c on c.character_id=a.current_tenant_id;

-- LEFT JOIN Example
-- All characters, including those without apartments
select * from apartments a right join characters c on c.character_id=a.current_tenant_id;


-- RIGHT JOIN Example
-- All apartments, including those without tenants
select * from apartments a left join characters c on c.character_id=a.current_tenant_id;
